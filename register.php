    ...
    <h4>Voer hier uw persoonlijke gegevens in</h4>
    <br />
...
<form action="">
        ...
        <div class="form-row">
            <div class="form-group col-md-2">
                <label for="stad">Telefoonnummer</label>
                <input type="text" class="form-control" name="phoneNumber" placeholder="Telefoonnummer" required />
            </div>
        </div>
        ...
        <h5>U krijgt een e-mail op dit account waar u uw wachtwoord kan instellen</h5>

        <div class="form-row">
            <div class="form-group col-md-3">
                <label for="stad">E-mail</label>
